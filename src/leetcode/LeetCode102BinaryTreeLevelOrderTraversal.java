...
public class LeetCode102BinaryTreeLevelOrderTraversal {
    ...
    public List<List<Integer>> levelOrder(TreeNode root) {
        ...
        levelOrderHelper(currentLevel, result);

        return result;
    }

    private void levelOrderHelper(List<TreeNode> currentLevel, List<List<Integer>> result) {
        ...
        levelOrderHelper(nextLevel, result);
    }
}
